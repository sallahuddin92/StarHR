    ...
    <div className="flex h-screen w-full items-center justify-center bg-background-light dark:bg-background-dark">
      <div className="w-full max-w-md p-8">
        ...
        <div className="mt-8 p-4 rounded-xl bg-[#f8f8f5] dark:bg-[#23220f] border border-[#e6e6db] dark:border-[#3a3a30]">
          <p className="text-xs text-[#8c8b5f] mb-3 font-medium uppercase tracking-wider">
            Available Demo Accounts
          </p>
          <div className="space-y-2 text-xs">
            <div
              className="flex justify-between items-center p-2 rounded hover:bg-white dark:hover:bg-slate-800 cursor-pointer"
              onClick={() => {
