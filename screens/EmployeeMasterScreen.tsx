                            ...
                            <table className="w-full text-left border-collapse">
                                <thead>
                                    <tr className="bg-[#f8f8f5] dark:bg-[#23220f] border-b border-[#e6e6db] dark:border-[#3a392a]">
                                        ...
                                        <th className="py-3 px-6 text-xs font-semibold uppercase tracking-wider text-[#8c8b5f] text-right">Actions</th>
                                    </tr>
                                </thead>
                ...
                <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm">
                    <div className="bg-white dark:bg-[#23220f] rounded-xl shadow-2xl w-full max-w-md mx-4 p-6">
                        ...
                        <div className="flex items-center gap-4 mb-6">
                            ...
                            <div>
                                <h3 className="text-lg font-bold text-[#181811] dark:text-white">{selectedEmployee.full_name}</h3>
                        ...
                        <div className="space-y-4">
                            <div className="flex justify-between py-2 border-b border-[#e5e5e0] dark:border-[#3e3d25]">
                                ...
                                <span className="font-medium text-[#181811] dark:text-white">{selectedEmployee.email}</span>
                            </div>
                            <div className="flex justify-between py-2 border-b border-[#e5e5e0] dark:border-[#3e3d25]">
                                <span className="text-[#8c8b5f]">Department</span>
                                <span className="font-medium text-[#181811] dark:text-white">{selectedEmployee.department || '—'}</span>
                            </div>
                            <div className="flex justify-between py-2 border-b border-[#e5e5e0] dark:border-[#3e3d25]">
                                <span className="text-[#8c8b5f]">Designation</span>
                                <span className="font-medium text-[#181811] dark:text-white">{selectedEmployee.designation || '—'}</span>
                            </div>
                        </div>
                        <div className="mt-6">
                            <button
