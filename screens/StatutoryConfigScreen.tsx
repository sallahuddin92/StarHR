...
const ToggleSwitch: React.FC<{
  ...
  <label className="flex items-center justify-between cursor-pointer">
    ...
    <div className="relative">
      ...
      />
      <div
        className={`block w-14 h-8 rounded-full transition-colors ${enabled ? 'bg-primary' : 'bg-slate-200 dark:bg-slate-600'}`}
      ></div>
      <div
        className={`dot absolute left-1 top-1 bg-white w-6 h-6 rounded-full transition-transform ${enabled ? 'translate-x-6' : ''}`}
      ></div>
    </div>
  </label>
);
          ...
          <div className="space-y-8">
            <div>
              <h3 className="text-lg font-bold text-slate-900 dark:text-white mb-1">
                Foreign Worker Mandate (2025)
              </h3>
              <p className="text-sm text-slate-500 dark:text-slate-400">
                Settings for non-citizen EPF contributions.
              </p>
            </div>
              ...
              <div className="flex">
                ...
                <div className="ml-3">
                  <p className="text-sm text-blue-700 dark:text-blue-300">
                    Effective <span className="font-bold">Oct 1, 2025</span>, non-citizens and
                    expatriates (who have not elected to contribute) will be mandated to contribute
                    to EPF.
                  </p>
                </div>
              </div>
            ...
            <div className="space-y-6">
              <ToggleSwitch
                label="Enforce Foreign Worker Mandate (Oct 2025)"
                enabled={foreignWorkerMandate}
                setEnabled={setForeignWorkerMandate}
              />
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  <label
                    htmlFor="employer-rate"
                    className="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1"
                  >
                    Employer Rate (Foreign)
                  </label>
                  <div className="relative">
                    <input
                      type="text"
                      id="employer-rate"
                      defaultValue="2.0"
                      className="w-full pl-4 pr-8 py-2 rounded-lg border border-slate-300 dark:border-slate-600 bg-white dark:bg-slate-700 focus:ring-primary focus:border-primary"
                    />
      ...
      case 'socso':
        return (
          <div className="space-y-8">
            <div>
              <h3 className="text-lg font-bold text-slate-900 dark:text-white mb-1">
                SOCSO / EIS Configuration
              </h3>
              <p className="text-sm text-slate-500 dark:text-slate-400">
                Manage contribution rates and wage ceilings.
              </p>
            </div>
            <div>
              <label
                htmlFor="insured-wage-ceiling"
                className="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1"
              >
                Insured Wage Ceiling
              </label>
              <div className="relative max-w-xs">
                ...
                <input
                  type="text"
                  id="insured-wage-ceiling"
                  defaultValue="6,000.00"
                  className="w-full pl-9 pr-4 py-2 rounded-lg border border-slate-300 dark:border-slate-600 bg-white dark:bg-slate-700 focus:ring-primary focus:border-primary"
                />
              </div>
            </div>
            <div>
                    ...
                    <tr className="hover:bg-slate-50 dark:hover:bg-slate-700/30">
                      ...
                      <td className="p-3">
                        <input
                          type="text"
                          defaultValue="86.65"
                          className="w-24 p-1 rounded bg-slate-100 dark:bg-slate-600 border border-slate-300 dark:border-slate-500 text-right"
                        />
                      </td>
                      <td className="p-3">
                        <input
        ...
        return (
          <div className="space-y-8">
            <div>
              ...
              <p className="text-sm text-slate-500 dark:text-slate-400">
                Read-only view of the core tax calculation constants.
              </p>
            </div>
      ...
      default:
        return (
          <div>
            ...
            <p className="text-sm text-slate-500 dark:text-slate-400">
              General statutory settings for the organization.
            </p>
          </div>
        );
    }
  ...
  return (
    <div className="bg-background-light dark:bg-slate-900 min-h-screen">
      <header className="bg-white dark:bg-slate-800/50 border-b border-slate-200 dark:border-slate-800 px-8 py-4">
        ...
        <p className="text-sm text-slate-500 dark:text-slate-400">
          Manage statutory contribution rates and tax rules for Malaysia.
        </p>
      </header>
